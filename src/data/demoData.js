...
export const JOB_MARKET_DATA = {
  'Software Engineer': {
    ...
    averageSalaryRange: '€60k–€90k (EU) / $95k–$150k (US) / ₹8–24 LPA (IN)',
  ...
  'Full Stack Developer': {
    ...
    trend: 'Accelerating',
    projectedDemand: 'VERY HIGH',
    topSkills: ['React', 'Node.js', 'TypeScript', 'SQL', 'Next.js', 'Docker'],
    averageSalaryRange: '€55k–€85k (EU) / $90k–$140k (US) / ₹7–22 LPA (IN)',
    disclaimer: 'Demand indicators are estimated trends. Actual job market conditions vary. Research current job postings for up-to-date data.',
    topCountries: ['Germany', 'USA', 'UK', 'Canada', 'India'],
    topCompanies: ['Shopify', 'Stripe', 'Spotify', 'Klarna', 'Amazon'],
  },
  'Frontend Engineer': {
    currentDemand: 'HIGH',
    trend: 'Growing',
    projectedDemand: 'HIGH',
    topSkills: ['JavaScript', 'TypeScript', 'React', 'CSS Architecture', 'Web Performance'],
    averageSalaryRange: '€50k–€80k (EU) / $85k–$135k (US) / ₹6–20 LPA (IN)',
    disclaimer: 'Demand indicators are estimated trends. Actual job market conditions vary. Research current job postings for up-to-date data.',
    topCountries: ['Germany', 'USA', 'UK', 'Netherlands'],
    topCompanies: ['Airbnb', 'Vercel', 'Meta', 'DoorDash'],
  },
  'Backend Engineer': {
    currentDemand: 'VERY HIGH',
    trend: 'Surging',
    projectedDemand: 'VERY HIGH',
    topSkills: ['Go', 'Python', 'Java', 'Distributed Systems', 'PostgreSQL', 'Docker'],
    averageSalaryRange: '€60k–€95k (EU) / $100k–$155k (US) / ₹9–26 LPA (IN)',
    disclaimer: 'Demand indicators are estimated trends. Actual job market conditions vary. Research current job postings for up-to-date data.',
    topCountries: ['Germany', 'USA', 'Switzerland', 'UK', 'Canada'],
    topCompanies: ['Uber', 'Google', 'Netflix', 'Adyen', 'Cloudflare'],
  },
  'AI / Machine Learning Engineer': {
    currentDemand: 'VERY HIGH',
    trend: 'Exponential',
    projectedDemand: 'VERY HIGH',
    topSkills: ['PyTorch', 'Python', 'LLMs & RAG', 'MLOps', 'TensorFlow', 'FastAPI'],
    averageSalaryRange: '€65k–€105k (EU) / $110k–$175k (US) / ₹10–32 LPA (IN)',
    disclaimer: 'Demand indicators are estimated trends. Actual job market conditions vary. Research current job postings for up-to-date data.',
    topCountries: ['USA', 'Germany', 'UK', 'Canada', 'France'],
    topCompanies: ['OpenAI', 'Anthropic', 'Google DeepMind', 'Mistral AI', 'NVIDIA'],
  },
  'Data Scientist': {
    currentDemand: 'HIGH',
    trend: 'Steady',
    projectedDemand: 'HIGH',
    topSkills: ['Python', 'SQL', 'Statistics', 'Pandas', 'Scikit-Learn', 'Tableau'],
    averageSalaryRange: '€58k–€90k (EU) / $95k–$150k (US) / ₹8–25 LPA (IN)',
    disclaimer: 'Demand indicators are estimated trends. Actual job market conditions vary. Research current job postings for up-to-date data.',
    topCountries: ['USA', 'Germany', 'UK', 'Canada'],
    topCompanies: ['McKinsey', 'Amazon', 'BioNTech', 'Palantir'],
  },
  'Data Engineer': {
    currentDemand: 'VERY HIGH',
    trend: 'Surging',
    projectedDemand: 'VERY HIGH',
    topSkills: ['Apache Spark', 'Python', 'SQL', 'Airflow', 'Snowflake', 'AWS'],
    averageSalaryRange: '€62k–€95k (EU) / $105k–$160k (US) / ₹9–28 LPA (IN)',
    disclaimer: 'Demand indicators are estimated trends. Actual job market conditions vary. Research current job postings for up-to-date data.',
    topCountries: ['Germany', 'USA', 'Netherlands', 'UK'],
    topCompanies: ['Databricks', 'Snowflake', 'Capital One', 'Booking.com'],
  },
  'DevOps & Cloud Engineer': {
    currentDemand: 'VERY HIGH',
    trend: 'Accelerating',
    projectedDemand: 'VERY HIGH',
    topSkills: ['Kubernetes', 'Docker', 'Terraform', 'AWS', 'Linux', 'CI/CD'],
    averageSalaryRange: '€62k–€100k (EU) / $105k–$165k (US) / ₹9–27 LPA (IN)',
    disclaimer: 'Demand indicators are estimated trends. Actual job market conditions vary. Research current job postings for up-to-date data.',
    topCountries: ['Germany', 'USA', 'UK', 'Switzerland'],
    topCompanies: ['Red Hat', 'AWS', 'HashiCorp', 'GitLab', 'Snyk'],
  },
  'Cybersecurity Analyst': {
    currentDemand: 'VERY HIGH',
    trend: 'Critical',
    projectedDemand: 'VERY HIGH',
    topSkills: ['SIEM', 'Network Protocols', 'Threat Intelligence', 'Linux', 'OWASP', 'Burp Suite'],
    averageSalaryRange: '€58k–€92k (EU) / $95k–$150k (US) / ₹8–24 LPA (IN)',
    disclaimer: 'Demand indicators are estimated trends. Actual job market conditions vary. Research current job postings for up-to-date data.',
    topCountries: ['USA', 'Germany', 'UK', 'Israel'],
    topCompanies: ['CrowdStrike', 'Palo Alto Networks', 'Darktrace', 'Mandiant'],
  },
  'Mobile App Developer': {
    currentDemand: 'HIGH',
    trend: 'Growing',
    projectedDemand: 'HIGH',
    topSkills: ['React Native', 'Flutter', 'Swift', 'Kotlin', 'REST APIs', 'Mobile UI'],
    averageSalaryRange: '€52k–€85k (EU) / $90k–$140k (US) / ₹7–22 LPA (IN)',
    disclaimer: 'Demand indicators are estimated trends. Actual job market conditions vary. Research current job postings for up-to-date data.',
    topCountries: ['Germany', 'USA', 'UK', 'India'],
    topCompanies: ['Revolut', 'Duolingo', 'Uber', 'N26'],
  },
  'QA / Test Automation Engineer': {
    currentDemand: 'HIGH',
    trend: 'Steady',
    projectedDemand: 'HIGH',
    topSkills: ['Selenium', 'Playwright', 'Python/Java', 'API Testing', 'CI/CD', 'Git'],
    averageSalaryRange: '€48k–€75k (EU) / $80k–$125k (US) / ₹5–16 LPA (IN)',
    disclaimer: 'Demand indicators are estimated trends. Actual job market conditions vary. Research current job postings for up-to-date data.',
    topCountries: ['Germany', 'USA', 'UK', 'Canada', 'India'],
    topCompanies: ['Thoughtworks', 'Epam', 'Electronic Arts', 'Capgemini'],
  },
};
